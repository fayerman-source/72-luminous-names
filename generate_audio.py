...
if __name__ == "__main__":
    ...
    for name in NAMES:
        generate_audio(name, output_dir)

    print(f"\n✓ Generated {len(NAMES)} placeholder audio files in {output_dir}/")
    print("Note: These are test tones. Replace with real meditation recordings.")
